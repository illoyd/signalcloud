...
class PhoneNumbersControllerTest < ActionController::TestCase
  ...
  test "should create phone_number" do
    assert_difference('PhoneNumber.count') do
      post :create, phone_number: { account: @phone_number.account, encrypted_number: @phone_number.encrypted_number, our_cost: @phone_number.our_cost, provider_cost: @phone_number.provider_cost }
    end
  ...
  test "should update phone_number" do
    put :update, id: @phone_number, phone_number: { account: @phone_number.account, encrypted_number: @phone_number.encrypted_number, our_cost: @phone_number.our_cost, provider_cost: @phone_number.provider_cost }
    assert_redirected_to phone_number_path(assigns(:phone_number))
  end
