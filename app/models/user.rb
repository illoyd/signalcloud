class User < ActiveRecord::Base
  ...
  ROLES = [ :shadow_account, :manage_account, :manage_users, :manage_user_permissions, :manage_stencils, :manage_phone_numbers, :manage_phone_books, :start_ticket, :force_ticket, :manage_ledger_entries ]
