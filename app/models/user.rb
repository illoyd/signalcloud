class User < ActiveRecord::Base
  ...
  ROLES = [ :shadow_account, :manage_account, :manage_users, :manage_user_permissions, :manage_appliances, :manage_phone_numbers, :manage_phone_directories, :start_ticket, :force_ticket, :manage_ledger_entries ]
