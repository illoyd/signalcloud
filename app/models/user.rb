class User < ActiveRecord::Base
  ...
  ROLES = [ :shadow_account, :manage_account, :manage_users, :manage_appliances, :manage_phone_numbers, :manage_phone_directories, :force_ticket, :start_ticket, :manage_ledger_entries ]
