class Appliance < ActiveRecord::Base
  ...
  attr_accessible :label, :primary, :phone_directory_id, :seconds_to_live, :confirmed_reply, :denied_reply, :expected_confirmed_answer, :expected_denied_answer, :expired_reply, :failed_reply, :question, :description
