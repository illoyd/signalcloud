...
Devise.setup do |config|
  ...
  config.http_authentication_realm = DIGEST_REALM
  ...
  config.omniauth :google_oauth2, ENV['GOOGLE_KEY'], ENV['GOOGLE_SECRET'], { access_type: 'offline', scope: 'https://www.googleapis.com/auth/plus.me, https://www.googleapis.com/auth/userinfo.email, https://www.googleapis.com/auth/userinfo.profile, https://www.googleapis.com/auth/drive.metadata.readonly, https://www.googleapis.com/auth/drive.file' }
