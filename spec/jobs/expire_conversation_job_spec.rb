    ...
    context 'when conversation is open' do
      ...
      context 'and conversation has not yet passed expiration' do
        ...
        it 'does not create a new ledger entry' do
          expect { subject.perform }.not_to change{conversation.stencil.account.ledger_entries.count}
        end
...
#               conversation.reload
#     
#             }.to_not change{conversation.stencil.account.ledger_entries.count}.by(1)
      ...
      context 'and conversation has passed expiration' do
        it 'expires conversation' do
          expect { # Messages count
            ...
            }.to_not change{ready_to_expire_conversation.stencil.account.ledger_entries.count}
    ...
    context 'when conversation is closed' do
      it 'ignores confirmed conversation' do
        expect { # Messages count
          ...
          }.to_not change{confirmed_conversation.stencil.account.ledger_entries.count}.by(1)
      ...
      it 'ignores denied conversation' do
        expect { # Messages count
          ...
          }.to_not change{denied_conversation.stencil.account.ledger_entries.count}.by(1)
      ...
      it 'ignores failed conversation' do
        expect { # Messages count
          ...
          }.to_not change{failed_conversation.stencil.account.ledger_entries.count}.by(1)
      ...
      it 'ignores expired conversation' do
        expect { # Messages count
          ...
          }.to_not change{expired_conversation.stencil.account.ledger_entries.count}.by(1)
