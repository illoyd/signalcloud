...
describe 'routing to phone numbers' do
  ...
  it 'allows searching' do
    ...
    expect( :get => '/phone_numbers/search' ).to route_to( controller: 'phone_numbers', action: 'search', country: 'US' )
    expect( :get => '/phone_numbers/search/US' ).to route_to( controller: 'phone_numbers', action: 'search', country: 'US' )
    expect( :get => '/phone_numbers/search/CA' ).to route_to( controller: 'phone_numbers', action: 'search', country: 'CA' )
    expect( :get => '/phone_numbers/search/GB' ).to route_to( controller: 'phone_numbers', action: 'search', country: 'GB' )
  end
  
  it 'allows buying' do
    expect( :post => 'phone_numbers/buy' ).to route_to( controller: 'phone_numbers', action: 'buy' )
    pending 'Needs analysis of how to block #show gloming on to "buy".'
    expect( :get => 'phone_numbers/buy' ).not_to be_routable
  end
