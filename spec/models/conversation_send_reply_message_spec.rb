  ...
  context 'when sending confirmation reply' do
    context 'when not already sent' do
      ...
      context 'and is typical' do
        ...
        subject { create :conversation, :challenge_sent, :response_received, :confirmed, stencil: stencil, confirmed_reply: confirmed_reply }
    ...
    context 'when already sent' do
      subject { create :conversation, :challenge_sent, :response_received, :confirmed, :reply_sent, stencil: stencil }
  ...
  context 'when sending denied reply' do
    context 'when not already sent' do
      ...
      context 'and is typical' do
        ...
        subject { create :conversation, :challenge_sent, :response_received, :denied, stencil: stencil, denied_reply: denied_reply }
    ...
    context 'when already sent' do
      subject { create :conversation, :challenge_sent, :denied, :reply_sent, stencil: stencil }
      it "should not resend challenge" do
        expect{ subject.send_reply_message!() }.to raise_error( SignalCloud::ReplyAlreadySentError )
      end
    end
  ...
  context 'when sending failed reply' do
    context 'when not already sent' do
      ...
      context 'and is typical' do
        ...
        subject { create :conversation, :challenge_sent, :response_received, :failed, stencil: stencil, failed_reply: failed_reply }
    ...
    context 'when already sent' do
      subject { create :conversation, :challenge_sent, :response_received, :failed, :reply_sent, stencil: stencil }
      it "should not resend challenge" do
        expect{ subject.send_reply_message!() }.to raise_error( SignalCloud::ReplyAlreadySentError )
      end
    end
  ...
  context 'when sending expired reply' do
    context 'when not already sent' do
      ...
      context 'and is typical' do
        ...
        subject { create :conversation, :challenge_sent, :response_received, :expired, stencil: stencil, expired_reply: expired_reply }
    ...
    context 'when already sent' do
      subject { create :conversation, :challenge_sent, :response_received, :expired, :reply_sent, stencil: stencil }
      it "should not resend challenge" do
        expect{ subject.send_reply_message!() }.to raise_error( SignalCloud::ReplyAlreadySentError )
      end
    end
